...
Lesson's 1 and 2 can be run simply by opening the associated HTML
...
These can be installed with version manager `asdf` from the `bash`
...
Lessons 3 and 4 can now be viewing by `cd`ing to their respective
...
For Lesson 5, see [Lesson 5 README](https://github.com/slewsys/reactjs-demo/tree/master/lesson5#readme)
